...
* Check the latest stable version of the amd64 binary at [https://golang.org/dl/](https://golang.org/dl/){:target="_blank"} and download it
...
Calculate the SHA256 hash of the downloaded file, it should be the same number as the one on the website
  ...
  > 57a9171682e297df1a5bd287be056ed0280195ad079af90af16dcad4f64710cb  go1.19.3.linux-amd64.tar.gz
  ```
