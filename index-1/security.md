...
{% hint style="danger" %}
ATTENTION!!! Do not proceed to the [next Uninstall section](https://app.gitbook.com/s/PwUXd13GpYIkFW2A1Gwj/system/system/privacy#uninstall) if you **do not wish to uninstall**. Skip directly to the [Extras (optional)](security.md#extras-optional) section
{% endhint %}
