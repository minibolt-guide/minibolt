...
* Log out the existing `temp` user:

```sh
logout
```

* Repeat [Access with Secure Shell](remote-access.md#access-with-secure-shell), but this time log in with `admin` and your `password [A]`
